/*Given a n*n square matrix, you need to select n elements in it so that exactly one element is selected in each row and column, and the sum of the values of these elements is the smallest. Complexity O(n^3)*/
#define INF 1e18
